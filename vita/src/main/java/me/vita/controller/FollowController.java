...
public class FollowController {
	...
	@Auth
	@ResponseBody
	public List<FollowDTO> getListFollower(@SessionAttribute("authUser") UserVO user,
			@PathVariable("search") String search, @PathVariable("page") Integer page) {
	...
	@Auth
	@ResponseBody
	public List<FollowDTO> getListFollowing(@SessionAttribute("authUser") UserVO user,
			@PathVariable("search") String search, @PathVariable("page") Integer page) {
		search = checkNull(search);
		String userId = user.getUserId();
